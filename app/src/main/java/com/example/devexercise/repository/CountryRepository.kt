...
import com.example.devexercise.repository.impl.IsCacheExpiredData
import com.example.devexercise.repository.impl.RefreshData
import com.example.devexercise.repository.impl.SetCacheTimeData
...
class CountryRepository @Inject constructor(private val database: LocalDatabase, private val service: ArcgisApiService, private val sharedPreferences: SharedPreferences, private val dateProvider: DateProvider):
    RefreshData, IsCacheExpiredData, SetCacheTimeData {
    ...
    @RequiresApi(Build.VERSION_CODES.O)
    override fun isCacheExpiredData(): Boolean {
    ...
    override fun setCacheTimeData(time: Long){
